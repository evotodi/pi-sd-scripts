...
usage() {
  ...
  echo "-g|--gz              Compress image with gzip" 1>&2
  echo "-s|--squash          (default) Compress image with squashfs" 1>&2
...
LONG_OPTS=squashfile:bs:temploc:nocompress,gzip,squash,nodcfldd,dryrun,verbose,help
OPTIONS=f:b:t:ngsdvh
